...
public class Main {
    public static void main(String[] args) {
        ...
        Product prod1 = new Product(1,200,"Camiseta dri-fit");
        Product prod2 = new Product(2,250,"Chuteira");
        Product prod3 = new Product(3,500,"Bola");

        ShoppingCart cart1 = new ShoppingCart(4,0);
        ShoppingCart cart2 = new ShoppingCart(5,0);
